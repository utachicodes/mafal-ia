...
interface RestaurantsContextType {
  ...
  updateRestaurant: (id: string, updates: Partial<Business>) => void
  deleteRestaurant: (id: string) => void
  getBusinessById: (id: string) => Restaurant | undefined
  isLoading: boolean
}

const RestaurantsContext = createContext<RestaurantsContextType | undefined>(undefined)

export function BusinessesProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateRestaurant = useCallback(async (id: string, updates: Partial<Business>) => {
    // Optimistic update
    setRestaurants((prev) =>
      prev.map((restaurant) =>
