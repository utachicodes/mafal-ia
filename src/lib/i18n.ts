...
export const translations = {
    en: {
        ...
        hero: {
            headline: "Your business works",
            headlineHighlight: "even when you don't.",
            headlineEnd: "",
        ...
        testimonials: {
            title: 'Discover what our customers say about',
            titleHighlight: 'Mafalia',
            description: 'Join hundreds of businesses that trust Mafal-IA',
            items: [
                { name: "Caesar's Lounge", subtitle: "Caesar's Lounge - Eat-Drink-Enjoy", quote: "They have greatly saved my life and are still doing so! So I am highly appreciative of all their services.", stars: 5 },
                { name: "Le Carre", subtitle: "Le Carre - Restaurant", quote: "Mafalia has transformed the way we take orders. Our WhatsApp is now our best sales channel.", stars: 5 },
                { name: "LEO", subtitle: "LEO - Restaurant-Coffee Shop", quote: "They have greatly saved my life and are still doing so! So I am highly appreciative of all their services.", stars: 5 },
                { name: "La Plancha", subtitle: "La Plancha - Buffet Restaurant", quote: "Setup was incredibly easy and the results were immediate. Our customers love the convenience.", stars: 5 },
                { name: "Exotic BBQ", subtitle: "Exotic BBQ - Grill House", quote: "Revenue increased by 40% in the first month. The automated responses are a game changer.", stars: 5 },
                { name: "Chez Ami", subtitle: "Chez Ami - Fine Dining", quote: "Professional service that truly understands the restaurant business. Highly recommended.", stars: 4 },
                { name: "Dakar Bites", subtitle: "Dakar Bites - Fast Food", quote: "Our order volume doubled since using Mafalia. The WhatsApp integration is seamless.", stars: 5 },
                { name: "Teranga Cafe", subtitle: "Teranga Cafe - Coffee & Pastry", quote: "Best investment we've made for our business. Customer satisfaction is through the roof.", stars: 5 },
            ],
        },
        cta: {
    ...
    fr: {
        ...
        hero: {
            headline: "Votre business travaille",
            headlineHighlight: "même quand vous ne travaillez pas.",
            headlineEnd: "",
        ...
        testimonials: {
            title: 'Découvrez ce que nos clients disent de',
            titleHighlight: 'Mafalia',
            description: 'Rejoignez des centaines de commerces qui font confiance à Mafal-IA',
            items: [
                { name: "Caesar's Lounge", subtitle: "Caesar's Lounge - Eat-Drink-Enjoy", quote: "Ils m'ont vraiment sauvé la vie et continuent de le faire ! Je suis très reconnaissant de tous leurs services.", stars: 5 },
                { name: "Le Carre", subtitle: "Le Carre - Restaurant", quote: "Mafalia a transformé notre façon de prendre les commandes. Notre WhatsApp est maintenant notre meilleur canal de vente.", stars: 5 },
                { name: "LEO", subtitle: "LEO - Restaurant-Coffee Shop", quote: "Ils m'ont vraiment sauvé la vie et continuent de le faire ! Je suis très reconnaissant de tous leurs services.", stars: 5 },
                { name: "La Plancha", subtitle: "La Plancha - Buffet Restaurant", quote: "La mise en place a été incroyablement facile et les résultats ont été immédiats. Nos clients adorent la commodité.", stars: 5 },
                { name: "Exotic BBQ", subtitle: "Exotic BBQ - Grill House", quote: "Le chiffre d'affaires a augmenté de 40% le premier mois. Les réponses automatisées changent la donne.", stars: 5 },
                { name: "Chez Ami", subtitle: "Chez Ami - Fine Dining", quote: "Un service professionnel qui comprend vraiment le business de la restauration. Hautement recommandé.", stars: 4 },
                { name: "Dakar Bites", subtitle: "Dakar Bites - Fast Food", quote: "Notre volume de commandes a doublé depuis que nous utilisons Mafalia. L'intégration WhatsApp est parfaite.", stars: 5 },
                { name: "Teranga Cafe", subtitle: "Teranga Cafe - Coffee & Pastry", quote: "Le meilleur investissement que nous avons fait pour notre business. La satisfaction client est au top.", stars: 5 },
            ],
        },
        cta: {
    ...
    ar: {
        ...
        hero: {
            headline: "عملك يشتغل",
            headlineHighlight: "حتى وأنت نايم.",
            headlineEnd: "",
        ...
        testimonials: {
            title: 'اكتشف ما يقوله عملاؤنا عن',
            titleHighlight: 'Mafalia',
            description: 'انضم إلى مئات الشركات التي تثق في Mafal-IA',
            items: [
                { name: "Caesar's Lounge", subtitle: "Caesar's Lounge - Eat-Drink-Enjoy", quote: "لقد أنقذوا حياتي حقًا ولا يزالون يفعلون ذلك! أنا ممتن جدًا لجميع خدماتهم.", stars: 5 },
                { name: "Le Carre", subtitle: "Le Carre - Restaurant", quote: "غيّرت مفاليا طريقة تلقي الطلبات لدينا. واتساب أصبح أفضل قناة مبيعات لنا.", stars: 5 },
                { name: "LEO", subtitle: "LEO - Restaurant-Coffee Shop", quote: "لقد أنقذوا حياتي حقًا ولا يزالون يفعلون ذلك! أنا ممتن جدًا لجميع خدماتهم.", stars: 5 },
                { name: "La Plancha", subtitle: "La Plancha - Buffet Restaurant", quote: "كان الإعداد سهلاً بشكل لا يصدق والنتائج كانت فورية. عملاؤنا يحبون الراحة.", stars: 5 },
                { name: "Exotic BBQ", subtitle: "Exotic BBQ - Grill House", quote: "ارتفعت الإيرادات بنسبة 40% في الشهر الأول. الردود التلقائية غيّرت قواعد اللعبة.", stars: 5 },
                { name: "Chez Ami", subtitle: "Chez Ami - Fine Dining", quote: "خدمة احترافية تفهم حقًا أعمال المطاعم. موصى به بشدة.", stars: 4 },
                { name: "Dakar Bites", subtitle: "Dakar Bites - Fast Food", quote: "تضاعف حجم طلباتنا منذ استخدام مفاليا. تكامل واتساب سلس.", stars: 5 },
                { name: "Teranga Cafe", subtitle: "Teranga Cafe - Coffee & Pastry", quote: "أفضل استثمار قمنا به لأعمالنا. رضا العملاء في أعلى مستوياته.", stars: 5 },
            ],
        },
        cta: {
