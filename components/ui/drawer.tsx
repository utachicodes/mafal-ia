  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex h-auto flex-col",
          side === "right" && "inset-y-0 right-0 w-3/4 border-l sm:max-w-sm",
          side === "left" && "inset-y-0 left-0 w-3/4 border-r sm:max-w-sm",
          side === "top" && "inset-x-0 top-0 max-h-[80vh] rounded-b-lg border-b",
